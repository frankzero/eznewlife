...
abstract class ___db extends __db{
    ...
    public abstract function geto($arguments, $fetch='FETCH_OBJ');

    public abstract function firsto($arguments, $fetch='FETCH_OBJ');
    ...
    protected function time_stop(){
        ...
        if($this->debug){
            $this->_print($t.' ms   '.$this->entire_sql);
        }

        $this->callback($t, $this->entire_sql);
    ...
    */
    public function select($arguments,$fetch='FETCH_ASSOC'){
        ...
        if( !is_array($arguments) ){
            ...
            $fetch = $this->fetch_style($this->fetch);
        }else{
    ...
    public function geto($arguments,$fetch='FETCH_OBJ'){
    ...
    public function firsto($arguments, $fetch='FETCH_OBJ'){
    ...
    private function make_stmt( $sql,$arguments){
        ...
        //if($this->debug) $this->_print($this->entire_sql);
