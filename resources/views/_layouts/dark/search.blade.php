<div class="alert  alert-dismissible  center-block   text-center"   role="alert"  itemscope itemtype="http://schema.org/WebSite">
    <link itemprop="url" href="{{route('darks.index')}}"/>
    {!!Form::open(['route'=>['darks.search'],"itemprop"=>"potentialAction","itemscope", "itemtype"=>"http://schema.org/SearchAction",'method'=>'get','id' => 'dark_search','class'=>"form-horizontal dark_search"])!!}
    <meta itemprop="target" content="{{route('darks.search')}}?q={q}"/>
