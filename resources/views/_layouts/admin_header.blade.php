            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{('/images/128.png')}}" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="{{('/images/256.png')}}" class="img-circle" alt="User Image">
                            <p>
                                {{ Auth::user()->get()->name }}
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="{{('/images/128.png')}}" class="img-circle" alt="User Image">
            </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview  @if ( strpos(Route::currentRouteName(), 'users')!== false or strpos(Route::currentRouteName(), 'analysis')==true ) active @endif">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ URL('admin/av_users/ajax') }}"><i class="fa fa-circle-o"></i>AvBody列表</a></li>
                    <li><a href="{{ URL('admin/av/analysis') }}"><i class="fa fa-circle-o"></i>AvBody分析</a></li>
                ...
                <li class="treeview  @if ( strpos(Route::currentRouteName(), 'parameters')!== false) active @endif">
                    ...
                    <ul class="treeview-menu">
                        @foreach(Config::get('app.domain') as $key=>$val )
                            ...
                            <li><a href="{{ URL('admin/parameters/categories?domain='.$val) }}"><i class="fa fa-circle-o"></i>{{$key}}類別</a></li>
            ...
            @endif
            @if (Auth::user()->get()->role=="A")
                <li class="treeview  @if ( strpos(Route::currentRouteName(), 'categories')!== false) active @endif">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ URL('admin/categories/create') }}"><i class="fa fa-circle-o"></i> 新增類別</a></li>
                        <li><a href="{{ URL('admin/categories') }}"><i class="fa fa-circle-o"></i>文章類別</a>
                        </li>
                    </ul>
                </li>
            @endif
            ...
            <li class="treeview  @if ( strpos(Route::currentRouteName(), 'articles')!== false) active @endif">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ URL('admin/articles/list') }}"><i class="fa fa-circle-o"></i>文章列表</a>
                    </li>
                </ul>
            </li>
            <li class="treeview  @if ( strpos(Route::currentRouteName(), 'animations')!== false) active @endif">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ URL('animations/list') }}" target="_animations"><i class="fa fa-circle-o"></i>動圖預覽</a>
                    </li>
                </ul>
            <li class="treeview  @if ( strpos(Route::currentRouteName(), 'fb_lives')!== false) active @endif">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ URL('admin/fb_lives/create') }}"><i class="fa fa-circle-o"></i>新增直播</a></li>
                    <li><a href="{{ URL('admin/fb_lives/ajax') }}"><i class="fa fa-circle-o"></i>直播列表</a>
                    <li><a href="{{ URL('admin/fb_lives/desc') }}"><i class="fa fa-circle-o"></i>直播說明</a>
                    </li>
                </ul>
            </li>
                ...
                <li class="treeview  @if ( strpos(Route::currentRouteName(), 'logs')!== false) active @endif">
                    ...
                    <ul class="treeview-menu">
                        @foreach(Config::get('app.logs') as $val )
                            <li><a href="{{ URL('admin/logs/datatables?type='.$val) }}"><i class="fa fa-circle-o"></i>{{$val}}</a></li>
                        @endforeach
