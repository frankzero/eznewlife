                        ...
                        <div class="row">
                            <div class=" col-lg-2 ">
                                    ...
                                    @if (File::exists( public_path() . '/focus_photos'."/100/".$rand_articles[$i]->photo) and !empty($rand_articles[$i]->photo))
                                        <img  src="{!!cdn("focus_photos/100/".$rand_articles[$i]->photo) !!}?lastmod={!!$article->updated_at!!}" class="img-responsive img-thumbnail img-small" alt="{{$rand_articles[$i]->title}}">
                                    @else
                                        <img src="{!!cdn("images/nophoto.png") !!}"   class="img-responsive img-thumbnail"  alt="{{$article->title}}">
                                    @endif
