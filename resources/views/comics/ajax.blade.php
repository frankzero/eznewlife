        ...
        @foreach ($other_articles as $k=> $article)
            ...
            @endif
            <div class="row center-block article-other-row" onclick="window.location='{{route('articles.show', ['id'=>$article->ez_map[0]->unique_id,'title'=>hyphenize($article->title)])}}'">
                ...
                <div class="col-md-6 col-sm-6 col-lg-6">
                    ...
                    <a href="{{route('articles.show', ['id'=>$article->ez_map[0]->unique_id,'title'=>hyphenize($article->title)])}}">
                        @if (File::exists( public_path() . '/focus_photos'."/".$article->photo) and !empty($article->photo))
                            <img  src="{!!asset("focus_photos/400/".$article->photo) !!}?lastmod={!!$article->updated_at!!}" class="img-responsive img-thumbnail img-middle" alt="{{$article->title}}">
                        @else
                            <img src="{!!asset("images/nophoto.png") !!}"   class="img-responsive "  alt="{{$article->title}}">
                        @endif
                    </a>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6">
                    ...
                    <div class="article-other-text" style="height: 100%">
                        <div class="body"> <h4><a href="{{route('articles.show', ['id'=>$article->ez_map[0]->unique_id,'title'=>hyphenize($article->title)])}}"><strong>
