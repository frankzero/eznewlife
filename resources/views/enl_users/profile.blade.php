        ...
        <div class="col-lg-9 col-md-12">
            <div class="profile-content">
                <div class="box box-primary">
                    ...
                    @endif
                    {!!Form::open(['route'=>['enl.user.update'],'method'=>'post','id' => 'profile_form','class'=>"form-horizontal",'files' => true])!!}
                    ...
                    <input name="_method" type="hidden" value="PUT">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nick_name" name="nick_name"  value="{{Auth::enl_user()->get()->nick_name}}" required placeholder="暱稱（公開）">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 uploadWrapper">
                                    ...
                                    <img id="target" src="{{Auth::enl_user()->get()->avatar."?".rand()}}" alt="your image" style="width:120px;height:120px" class="img-thumbnail"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control"  name="email" value="{{Auth::enl_user()->get()->email}}" id="email" placeholder="電子郵件" >
                                </div>
                            </div>
                        ...
                        <div class="box-footer ">
                            ...
                            <button type="submit" class="btn btn-info bg-enl col-lg-4 col-lg-offset-4 col-xs-8 col-xs-offset-2">設定</button>
...
''
    ...
    $('#profile_form').validate({
        rules: {
            ...
            email: {
                remote: {
                    url: "{{route('enl.user.check_repeat')}}",
                    type: "post",
                    data: {
                        type: 'update_email',
                        _token:"{{csrf_token()}}",
