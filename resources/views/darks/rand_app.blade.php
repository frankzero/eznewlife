    ...
    <div id="myCarousel" class="carousel slide center-block" data-ride="carousel">
        ...
        <div class="carousel-inner " role="listbox">
            @foreach ($articles as $k=> $article)
                <div class="item @if ($k==0) active @endif"  onclick="window.open('{{route('darks.show', ['id'=>$article->ez_map[0]->unique_id])}}')">
                    <a href="{{route('darks.show', ['id'=>$article->ez_map[0]->unique_id])}}" target="_blank" >
