...
@section('content')
    {!!seo_breadcrumb_list('ENL暗黑網',$categories[$articles[0]->category_id],route('darks.category',['id'=>$articles[0]->category_id,'title'=>hyphenize($categories[$articles[0]->category_id])]))!!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 tag_hidden">
                                        ...
                                        @foreach ($article->tags->pluck('name')->all() as $key =>$tag_name)
                                            <a href="{{route('darks.tag',['name'=>$tag_name])}}" rel="tag" class="btn btn-xs bg-orange btn-flat">{!!$tag_name!!}</a>
                                        @endforeach
                                    </div>
                                </div>
                            @endif
