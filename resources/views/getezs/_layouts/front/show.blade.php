...
@section('content')
    <div class="col-md-8 blog-main blog-main-show">
            ...
            <div class="body">
                ...
                {!!nl2br($article->content)!!}
                    ...
                    <div class="row">
                        ...
                        <div title="2" id="ad_block_2" class=" col-lg-6    text-center" style="" role="alert">
        ...
        <div title="8" id="ad_block_8">{!! get_adCode(8, $plan, __DOMAIN__) !!}</div>
                        ...
                        <div class="row">
                            <div class=" col-lg-2 ">
                                    ...
                                    @if (File::exists( public_path() . '/focus_photos'."/100/".$rand_articles[$i]->photo) and !empty($rand_articles[$i]->photo))
                                        <img  src="{!!asset("focus_photos/100/".$rand_articles[$i]->photo) !!}?lastmod={!!$article->updated_at!!}" class="img-responsive img-thumbnail img-small" alt="{{$rand_articles[$i]->title}}">
                                    @else
                                        <img src="{!!asset("images/nophoto.png") !!}"   class="img-responsive img-thumbnail"  alt="{{$article->title}}">
                                    @endif
