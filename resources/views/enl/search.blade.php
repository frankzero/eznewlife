...
<div class="alert  alert-dismissible  center-block   text-center"   role="alert" style="display:none;">
    {!!Form::open(['route'=>['articles.search'],'method'=>'get','id' => 'article_search','class'=>"form-horizontal article_search"])!!}
