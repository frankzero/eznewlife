        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <div class="box box-success">
                    ...
                    {!!Form::open(['route'=>['admin.categories.store'],'method'=>'post','id' => 'category_form','class'=>"form-horizontal",'files' => true])!!}
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="btn btn-success pull-right">新增類別</button>
                        </div>
                        <!-- /.box-footer -->
                        {!! Form::close() !!}
                    </div>
