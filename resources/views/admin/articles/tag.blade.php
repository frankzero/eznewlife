...
@section('content')
    <div class="col-md-8 blog-main">
                                ...
                                <div class="row_tag">
                                    ...
                                    <div class="col-xs-11 tag_hidden" >
                                        ...
                                        @foreach ($article->tags->pluck('name')->all() as $key =>$tag_name)
                                            <a href="{{route('articles.tag',['name'=>$tag_name])}}" class="btn btn-xs btn-default  @if ($tag_name==$page['sub_title']) bg-olive @endif" >{!!$tag_name!!}</a>
                                        @endforeach
                                    </div>
                                </div>
                            @endif
        ...
        <div class="row text-center">
            <div class="col-lg-offset-3 col-offset-6">{!!$tag_articles->render()!!}</div>
        </div>
        <article class="ad-lg">
            <div class="row">
