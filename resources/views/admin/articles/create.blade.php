...
@section('content')
    ...
    <div class="box box-success">
        ...
        {!!Form::open(['route'=>['admin.articles.store'],'method'=>'post','id' => 'article_form','class'=>"form-horizontal article_form",'files' => true])!!}
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-lg-5">
                        {!!Form::checkbox('flag', 'P', false)!!}
                    </div>
                </div>
                <div class="form-group">
                <label for="file" class="col-sm-2 col-lg-1 control-label">特色圖片</label>
                    <div class="col-sm-5 col-lg-3">
							<div id="article_bar" class="form-group"></div>
                        <input type='file' id="imgInp" name="photo"/>

                        <img id="blah" src="data:image/png;base64,
...
"  class="img-responsive img-thumbnail" alt="特色圖片" style="width:200px;height: 140px" data-toggle="tooltip"  data-placement="right" data-title="tip:建議圖片尺寸 640X480 (4*3 比例)"/>
                    </div>
                </div>
                <div class="form-group sandbox-container">
                    <label for="publish_date" class="col-sm-2 col-lg-1 control-label">發佈日期</label>
                    <div class="col-sm-4 col-lg-2">
                        {!!Form::text('publish_at',(Input::old('publish_at')) ? Input::old('publish_at') : $publish_at,array('class' => 'form-control','id'=>'publish_at','placeholder'=>'yyyy-mm-dd HH:ii'))!!}
            ...
            <!--<div class="box-footer"> -->
                ...
                <button type="submit" class="btn btn-success pull-right">新增文章</button>
            </div>--><!-- /.box-footer -->
                {!! Form::close() !!}
    </div>
