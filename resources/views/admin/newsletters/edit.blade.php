            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    ...
                    @if (count($errors) > 0)
                        ...
                        {!!Form::open(['route'=>['admin.newsletters.auto.update',$id],'method'=>'post','id' => 'article_edit','class'=>"form-horizontal article_form",'files' => true])!!}
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group sandbox-container">
                                ...
                                <div class="col-sm-10 col-lg-10">
                                 ...
                                 ,array('class' => 'input-block-level',  'rows'    => 18,'id'=>'summernote','maxlength'=>100,
                                 'placeholder'=>'請輸入信件內容'))!!}
