        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <div class="box box-warning">
                    ...
                    {!!Form::open(['route'=>['admin.users.update',$id],'method'=>'post','id' => 'user_edit','class'=>"form-horizontal",'files' => true])!!}
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="btn btn-success pull-right">修改用戶</button>
                        </div>
                        <!-- /.box-footer -->
                        {!! Form::close() !!}
                    </div>
