...
function ad_show(){ 
    ...
    var code = document.getElementById('text_ad_block_15').value;
    ...
    $(div).html(code);
    //div.contentWindow.document.write(code);

    //document.write(code);

    return;
    console.log('ad_show', SomaJS);

    if(typeof SomaJS !== 'undefined'){
        SomaJS.loadAd({
            adDivId: "smaatopopup",
