...
class MysqliDb
{
     ...
     * @param int $port
     */
    public function __construct($sys,$host, $username, $password, $db, $port = NULL)
    {
        $sys->load_once(ROOTPATH.'ezlib3/stopwatch.php');
    ...
    {
        $sw = new StopWatch();$this->__query='';$this->__where=array();
        ...
        $t = $sw->stop();
        $this->totalquerytime+=$t;
        
        $this->sys->debug($t.' rawQuery '.$query.' '.($bindParams?print_r($bindParams,true):''));
        return $result;
    }
    ...
    public function query($query, $numRows = null)
    {
        ...
        $t = $sw->stop();
        $this->totalquerytime+=$t;
        $this->sys->debug($t.' query '.$query.' '.($this->__where?print_r($this->__where,true):''));
        return $result;
    }
    ...
    public function get($tableName, $numRows = null, $columns = '*')
    {
        ...
        $t = $sw->stop();
        $this->totalquerytime+=$t;
        $this->sys->debug($t.' get '.$this->__query.' '.($this->__where?print_r($this->__where,true):''));
        return $result;
    }
     ...
     */
     public function getOne($tableName, $columns = '*') 
     {
        ...
        $result = (!empty($res[0]) ? $res[0] : array() );
        return $result;
     }
    ...
    public function insert($tableName, $insertData)
    {
        ...
        $t = $sw->stop();
        $this->totalquerytime+=$t;
        $this->sys->debug($t.' insert '.$this->__query.' '.($insertData?print_r($insertData,true):''));
        return $result;
    }
    ...
    public function update($tableName, $tableData)
    {
        ...
        $t = $sw->stop();
        $this->totalquerytime+=$t;
        $this->sys->debug($t.' update: '.$this->__query.' '.($this->__where?print_r($this->__where,true):''));
        return $result;
    }
    ...
    public function delete($tableName, $numRows = null)
    {
        ...
        $t = $sw->stop();
        $this->totalquerytime+=$t;
        $this->sys->debug($t.' delete: '.$this->__query.' '.($this->__where?print_r($this->__where,true):''));
        return $result;
    }
