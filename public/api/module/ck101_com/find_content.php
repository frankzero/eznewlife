...
use _scraping\find_content as ab;


class find_content extends ab{



     public function call($url, $selector){

        $this->html = parent::call($url, $selector);
    ...
    private function _youtube(){
        ...
        if(strpos($this->html, 'v.ck101.com/youtube.html') !== false){
            ...
            $this->html = str_replace('http://www.youtube.com/embed', 'https://www.youtube.com/embed', $this->html);
