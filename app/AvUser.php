...
class AvUser extends Model implements AuthenticatableContract,
    ...
    CanResetPasswordContract
{
     ...
     * @var array
     */
    protected $fillable = ['name','nick_name', 'email', 'password','facebook_id','avatar','login_counts','login_date'];
...
*/
    public function collects()
    {
        ...
        return $this->hasMany('App\AvUserCollect');
    }
